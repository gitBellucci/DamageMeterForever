...
do
	...
	-- Forever has Midnight APIs but vanilla content; use classic spell list.
	local bIsClassicWow = DetailsFramework.IsClassicWow() or DetailsFramework.IsForeverWow()
	...
	if (DetailsFramework.IsClassicWow() or DetailsFramework.IsForeverWow()) then
	...
	elseif (DetailsFramework.IsPandaWow()) then
		...
		--10.2
		customItemList[426672] = {itemId = 207168, isPassive = true, nameExtra = "(vers)", icon = [[Interface\AddOns\DamageMeterForever\images\spells\spell_druid_bearhug_blackwhite.jpg]]} --trinket: Pip's Emerald Friendship Badge urctos
		...
		customItemList[426676] = {itemId = 207168, isPassive = true, nameExtra = "(crit)", icon = [[Interface\AddOns\DamageMeterForever\images\spells\elf_face_right.jpg]]} --trinket: Pip's Emerald Friendship Badge aerwynn
		...
		customItemList[426647] = {itemId = 207168, isPassive = true, nameExtra = "(mast)", icon = [[Interface\AddOns\DamageMeterForever\images\spells\lil_dragon_left.jpg]]} --trinket: Pip's Emerald Friendship Badge pip
