...
SLASH_DETAILS1, SLASH_DETAILS2, SLASH_DETAILS3, SLASH_DETAILS4 = "/details", "/dt", "/de", "/df"
...
--	https://www.dropbox.com/s/ulyeqa2z0ummlu7/1024.tga?dl=0
			...
			a:SetScript("OnUpdate", function(self, deltaTime)
				...
				texture:SetTexture([[Interface\AddOns\DamageMeterForever\images\options_window]])
	...
	elseif (msg == "alert") then
		...
		if (lower_instance) then
			...
			if (instance) then
				...
				instance:InstanceAlert ("Boss Defeated, Open History! ", {[[Interface\AddOns\DamageMeterForever\images\icons]], 16, 16, false, 434/512, 466/512, 243/512, 273/512}, 40, func, true)
			end
		end
	...
	elseif (msg == "qq") then
		...
		--local icon = {[[Interface\AddOns\DamageMeterForever\images\icons]], 16, 16, false, 434/512, 466/512, 243/512, 273/512}
...
if (WOW_PROJECT_ID == WOW_PROJECT_MAINLINE) then
	...
	for i = 1, 30 do
		...
		detailsFramework:SetMask(teleportButton.Icon, [[Interface\AddOns\DamageMeterForever\images\masks\portal_mask.tga]])
...
--	})
	...
	local currentDungeons = LIB_OPEN_RAID_MYTHIC_PLUS_CURRENT_SEASON or {}
	local lastButton
	...
	local teleportersLabel = footer:CreateFontString(nil, "overlay")
	pcall(teleportersLabel.SetFont, teleportersLabel, "Fonts\\FRIZQT__.TTF", 12)
	teleportersLabel:SetTextColor(1, 0.82, 0, 1)
	teleportersLabel:SetPoint("topleft", footer, "topleft", 58, -9)
	teleportersLabel:SetText(Loc["STRING_TELEPORTERS"] or "Teleporters")
		...
		if (openRaidLib) then
			if (not DetailsKeystoneInfoFrame.Created) then
				...
				local mainTabSelectorRadioOptions = {{
						...
						param = "details",
						get = function()end,
						texture = [[Interface\AddOns\DamageMeterForever\images\minimap]],
						texcoord = {0, 1, 0, 1},
						mask = nil,
						width = 20,
						height = 20,
...
--]=]
				...
				local createLineForScroll = function(self, index)
					...
					detailsFramework:SetMask(blockTeleporterButton.Icon, [[Interface\AddOns\DamageMeterForever\images\masks\portal_mask.tga]])
