...
local default_profile = {
	...
	class_icons_small = [[Interface\AddOns\DamageMeterForever\images\classes_small]],
	class_coords = {
		["DEMONHUNTER"] = {
			0.73828126 / 2, -- [1]
			1 / 2, -- [2]
...
--	Details.streamer_config.
	...
	--tooltip
		tooltip = {
			...
			show_amount = false,
			commands = {},
			header_text_color = {0.047, 0.824, 0.616, 1}, -- Foofi teal
...
--/run Details.breakdown_spell_tab.spellcontainer_height = 311 --352
	...
	breakdown_spell_tab = {
		...
		statusbar_texture = [[Interface\AddOns\DamageMeterForever\images\bar_skyline]],
