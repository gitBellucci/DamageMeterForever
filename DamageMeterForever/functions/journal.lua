            ...
            if (spellId) then
                ...
                if (topDamage and topDamage > 0) then
                    ...
                    for i = 1, #damageDoneTable do
                        ...
                        gameCooltip:AddStatusBar(damageDone / topDamage * 100, 1, .5, .5, .5, 1, false, {value = 100, color = {.2, .2, .2, 0.9}, texture = [[Interface\AddOns\DamageMeterForever\images\bar_hyanda]]})
                    end
