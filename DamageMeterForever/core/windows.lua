...
--cooltip presets
	local preset3_backdrop = {bgFile = [[Interface\DialogFrame\UI-DialogBox-Background-Dark]], edgeFile = [[Interface\AddOns\DamageMeterForever\images\border_3]], tile=true,
	...
	local preset2_backdrop = {bgFile = [[Interface\AddOns\DamageMeterForever\images\background]], edgeFile = [[Interface\Buttons\WHITE8X8]], tile=true,
	...
	function Details:CooltipPreset(preset)
		...
		if not GameCooltip or not GameCooltip.Reset then
			return
		end
...
--feedback window
	function Details:OpenFeedbackWindow()
		if (not _G.DetailsFeedbackPanel) then
			...
			local wowi = gump:NewImage(panel, [[Interface\AddOns\DamageMeterForever\images\icons2]], 101, 34, "artwork", {0/512, 101/512, 163/512, 200/512})
			local curse = gump:NewImage(panel, [[Interface\AddOns\DamageMeterForever\images\icons2]], 101, 34, "artwork", {0/512, 101/512, 201/512, 242/512})
			local mmoc = gump:NewImage(panel, [[Interface\AddOns\DamageMeterForever\images\icons2]], 101, 34, "artwork", {0/512, 101/512, 243/512, 285/512})
	...
	f.logo:SetTexture([[Interface\AddOns\DamageMeterForever\images\damageforever_logo]])
	f.logo:SetSize(320, 100)
	...
	function Details:RegisterMinimap()
		...
		if LDB then
			local databroker = LDB:NewDataObject ("Details", {
				type = "data source",
				icon = [[Interface\AddOns\DamageMeterForever\images\minimap]],
				text = "0",
				...
				OnClick = function(self, button)
					...
					elseif (button == "RightButton") then
						...
						GameCooltip:AddIcon ([[Interface\AddOns\DamageMeterForever\images\icons]], 1, 1, 12, 11, 462/512, 473/512, 1/512, 11/512)
	...
	function Details:DoRegisterHotCorner()
		...
		if (_G.HotCorners) then
			_G.HotCorners:RegisterHotCornerButton (
				...
				--icon
				[[Interface\AddOns\DamageMeterForever\images\minimap]],
				--tooltip
				tooltip_hotcorner,
				--click function
...
function Details:InitializeAPIWindow()
	...
	DetailsAPI2Frame.__icon = [[Interface\AddOns\DamageMeterForever\images\icons]]
...
function Details:FormatBackground(frame) --deprecated I guess
	frame:SetBackdrop({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\DamageMeterForever\images\background]], tileSize = 64, tile = true})
	...
	frame.__background:SetTexture([[Interface\AddOns\DamageMeterForever\images\background]], true)
