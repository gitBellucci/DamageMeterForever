...
--Edit Buttons
	...
	--overlay color
		...
		resizer:SetNormalTexture([[Interface\AddOns\DamageMeterForever\images\skins\default_skin]])
		resizer:SetHighlightTexture([[Interface\AddOns\DamageMeterForever\images\skins\default_skin]])
