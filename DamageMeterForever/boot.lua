...
--follow game api definitions in the file LibLuaServer.lua
		...
		Details.curseforgeVersion = C_AddOns and C_AddOns.GetAddOnMetadata and C_AddOns.GetAddOnMetadata("DamageMeterForever", "Version")
		if (not Details.curseforgeVersion and GetAddOnMetadata) then
			Details.curseforgeVersion = GetAddOnMetadata("DamageMeterForever", "Version")
		end
		...
		-- Forever (TOC 16xxx) uses the same secret / C_DamageMeter model as Midnight 12.x
		local isWowApocalypse = (tvs >= 120000) or (tvs >= 16000 and tvs < 20000)
...
do
	...
	--containers
		...
		--tooltip
			...
			_detalhes.tooltip_target_icon = {file = [[Interface\AddOns\DamageMeterForever\images\icons]], coords = {0, 0.03125, 0.126953125, 0.15625}}

		--icons
			_detalhes.attribute_icons = [[Interface\AddOns\DamageMeterForever\images\atributos_icones]]
...
--functions
	...
	--register textures and fonts for shared media
		...
		--default bars
		SharedMedia:Register("statusbar", "Details Hyanda Reverse", [[Interface\AddOns\DamageMeterForever\images\bar_textures\bar_hyanda_reverse.png]])
		SharedMedia:Register("statusbar", "You Are the Best!", [[Interface\AddOns\DamageMeterForever\images\bar_textures\bar_best.png]])
		SharedMedia:Register("statusbar", "Details Hyanda", [[Interface\AddOns\DamageMeterForever\images\bar_hyanda]])

		SharedMedia:Register("statusbar", "Details D'ictum", [[Interface\AddOns\DamageMeterForever\images\bar4]])
		SharedMedia:Register("statusbar", "Details Vidro", [[Interface\AddOns\DamageMeterForever\images\bar4_vidro]])
		SharedMedia:Register("statusbar", "Details D'ictum (reverse)", [[Interface\AddOns\DamageMeterForever\images\bar4_reverse]])

		--flat bars
		SharedMedia:Register("statusbar", "Skyline", [[Interface\AddOns\DamageMeterForever\images\bar_skyline]])

		SharedMedia:Register("statusbar", "Details Serenity", [[Interface\AddOns\DamageMeterForever\images\bar_serenity]])
		SharedMedia:Register("statusbar", "BantoBar", [[Interface\AddOns\DamageMeterForever\images\BantoBar]])
		SharedMedia:Register("statusbar", "Skyline Compact", [[Interface\AddOns\DamageMeterForever\images\bar_textures\bar_skyline_compact.png]])
		...
		SharedMedia:Register("statusbar", "DGround", [[Interface\AddOns\DamageMeterForever\images\bar_background]])
		SharedMedia:Register("statusbar", "Details Flat", [[Interface\AddOns\DamageMeterForever\images\bar_background]])
		SharedMedia:Register("statusbar", "Splitbar", [[Interface\AddOns\DamageMeterForever\images\bar_textures\split_bar]])
		SharedMedia:Register("statusbar", "Details2020", [[Interface\AddOns\DamageMeterForever\images\bar_textures\texture2020]])
		SharedMedia:Register("statusbar", "Left White Gradient", [[Interface\AddOns\DamageMeterForever\images\bar_textures\gradient_white_10percent_left]])
		SharedMedia:Register("statusbar", "Details! Slash", [[Interface\AddOns\DamageMeterForever\images\bar_textures\bar_of_bars.png]])

		--window bg and bar order
		SharedMedia:Register("background", "Details Ground", [[Interface\AddOns\DamageMeterForever\images\background]])
		SharedMedia:Register("border", "Details BarBorder 1", [[Interface\AddOns\DamageMeterForever\images\border_1]])
		SharedMedia:Register("border", "Details BarBorder 2", [[Interface\AddOns\DamageMeterForever\images\border_2]])
		SharedMedia:Register("border", "Details BarBorder 3", [[Interface\AddOns\DamageMeterForever\images\border_3]])
		SharedMedia:Register("border", "1 Pixel", [[Interface\Buttons\WHITE8X8]])

		--misc fonts
		SharedMedia:Register("font", "Oswald", [[Interface\AddOns\DamageMeterForever\fonts\Oswald-Regular.ttf]])
		SharedMedia:Register("font", "Nueva Std Cond", [[Interface\AddOns\DamageMeterForever\fonts\Nueva Std Cond.ttf]])
		SharedMedia:Register("font", "Accidental Presidency", [[Interface\AddOns\DamageMeterForever\fonts\Accidental Presidency.ttf]])
		SharedMedia:Register("font", "TrashHand", [[Interface\AddOns\DamageMeterForever\fonts\TrashHand.TTF]])
		SharedMedia:Register("font", "Harry P", [[Interface\AddOns\DamageMeterForever\fonts\HARRYP__.TTF]])
		SharedMedia:Register("font", "FORCED SQUARE", [[Interface\AddOns\DamageMeterForever\fonts\FORCED SQUARE.ttf]])

		SharedMedia:Register("sound", "Details Gun1", [[Interface\AddOns\DamageMeterForever\sounds\sound_gun2.ogg]])
		SharedMedia:Register("sound", "Details Gun2", [[Interface\AddOns\DamageMeterForever\sounds\sound_gun3.ogg]])
		SharedMedia:Register("sound", "Details Jedi1", [[Interface\AddOns\DamageMeterForever\sounds\sound_jedi1.ogg]])
		SharedMedia:Register("sound", "Details Whip1", [[Interface\AddOns\DamageMeterForever\sounds\sound_whip1.ogg]])
		SharedMedia:Register("sound", "Details Horn", [[Interface\AddOns\DamageMeterForever\sounds\Details Horn.ogg]])

		SharedMedia:Register("sound", "Details Warning", [[Interface\AddOns\DamageMeterForever\sounds\Details Warning 100.ogg]])
		SharedMedia:Register("sound", "Details Truck", [[Interface\AddOns\DamageMeterForever\sounds\Details Truck.ogg]])
		SharedMedia:Register("sound", "Details Bass Drop", [[Interface\AddOns\DamageMeterForever\sounds\bassdrop2.mp3]])
