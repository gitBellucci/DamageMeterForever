...
function Details:InitializeRunCodeWindow()
    ...
    --DetailsRunCodePanel.__icon = [[Interface\AddOns\DamageMeterForever\images\lua_logo]]
    detailsRunCodePanel.__icon = [[Interface\AddOns\DamageMeterForever\images\run_code]]
