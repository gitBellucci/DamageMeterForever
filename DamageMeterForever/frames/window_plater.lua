...
function Details:InitializePlaterIntegrationWindow()
    ...
    DetailsPlaterIntegrationPanel.__icon = [[Interface\AddOns\DamageMeterForever\images\plater_icon]]
...
function Details.OpenPlaterIntegrationWindow()
    if (not DetailsPlaterIntegrationPanel or not DetailsPlaterIntegrationPanel.Initialized) then
        ...
        titleBackground.bg1:SetTexture([[Interface\AddOns\DamageMeterForever\images\background]])
        ...
        titleBackground:SetBackdrop({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\DamageMeterForever\images\background]], tileSize = 64, tile = true})
