...
local font_select_icon, font_select_texcoord = [[Interface\AddOns\DamageMeterForever\images\icons]], {472/512, 513/512, 186/512, 230/512}
    ...
    local buildSection = function(sectionFrame)
        ...
        --auto erase | erase data
            ...
            local eraseDataOptions = {
                {value = 1, label = Loc ["STRING_OPTIONS_ED1"], onclick = onSelectEraseData, icon = [[Interface\AddOns\DamageMeterForever\Images\reset_button2]]},
                {value = 2, label = Loc ["STRING_OPTIONS_ED2"], onclick = onSelectEraseData, icon = [[Interface\AddOns\DamageMeterForever\Images\reset_button2]]},
                {value = 3, label = Loc ["STRING_OPTIONS_ED3"], onclick = onSelectEraseData, icon = [[Interface\AddOns\DamageMeterForever\Images\reset_button2]]},
            }
        ...
        local sectionOptions = {
            ...
            {--ungroup instance
                ...
                icontexture = [[Interface\AddOns\DamageMeterForever\images\icons]],
        ...
        --skin selection
            ...
            local buildSkinMenu = function()
                ...
                for skin_name, skin_table in pairs(Details.skins) do
                    local file = skin_table.file:gsub([[Interface\AddOns\DamageMeterForever\images\skins\]], "")
...
do
    ...
    local texture_icon = [[Interface\AddOns\DamageMeterForever\images\icons]]
    ...
    local buildSection = function(sectionFrame)
        local sectionOptions = {
            ...
            {--button orange gear
                ...
                name = "",
                --desc = "",
                icontexture = [[Interface\AddOns\DamageMeterForever\images\toolbar_icons]],
...
do
    local buildSection = function(sectionFrame)
        ...
        --streamer plugin - a.k.a. Action Tracker
			...
			local streamerTitleImage = DF:CreateImage(sectionFrame, [[Interface\AddOns\DamageMeterForever\images\icons2.blp]], 268*0.75, 59*0.75, "overlay", {0, 268/512, 454/512, 1})
		...
		--event tracker
			...
			local eventTrackerTitleImage = DF:CreateImage(sectionFrame, [[Interface\AddOns\DamageMeterForever\images\icons2]], 256, 50, "overlay", {0.5, 1, 134/512, 184/512})
		...
		--arena kamehameha bar
			...
			local currentDPSTitleImage = DF:CreateImage(sectionFrame, [[Interface\AddOns\DamageMeterForever\images\icons2]], 256, 32, "overlay", {0/512, 256/512, 421/512, 453/512})
...
--panel
    ...
    big_code_editor:SetBackdrop({bgFile = [[Interface\AddOns\DamageMeterForever\images\background]], edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1,tile = 1, tileSize = 16})
    ...
    big_code_editor2:SetBackdrop({bgFile = [[Interface\AddOns\DamageMeterForever\images\background]], edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1,tile = 1, tileSize = 16})
    ...
    --add panel
        ...
        addframe:SetBackdrop({bgFile = [[Interface\AddOns\DamageMeterForever\images\background]], edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1,tile = 1, tileSize = 16})
    ...
    --open import panel button
        ...
        importframe:SetBackdrop({bgFile = [[Interface\AddOns\DamageMeterForever\images\background]], edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1,tile = 1, tileSize = 16})
