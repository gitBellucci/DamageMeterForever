...
function breakdownMidnight.CreateBreakdownWindow(windowIndex, parentFrame)
    ...
    windowFrame.playerData = windowFrame.playerData or { combatSources = {}, maxAmount = 0, totalAmount = 0 }
    if type(windowFrame.playerData.combatSources) ~= "table" then
        windowFrame.playerData.combatSources = {}
    end
